...
[![MCP](https://img.shields.io/badge/MCP-48%20tools-8A2BE2?style=flat-square)](backend/interfaces/mcp/server.py)
...
- **`backend/`** — Python: an MCP server (48 tools for Claude), an HTTP API
